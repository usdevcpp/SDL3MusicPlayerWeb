...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/Roboto-Regular.png", "start": 0, "end": 13996}], "remote_package_size": 13996});

  })();

// end include: /tmp/tmp5vngpjbx.js
...
var ASM_CONSTS = {
  155688: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 155903: () => { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } Module['SDL3'].dummy_audio = {}; Module['SDL3'].dummy_audio.timers = []; Module['SDL3'].dummy_audio.timers[0] = undefined; Module['SDL3'].dummy_audio.timers[1] = undefined; },  
 156149: ($0, $1, $2, $3, $4) => { var a = Module['SDL3'].dummy_audio; if (a.timers[$0] !== undefined) { clearInterval(a.timers[$0]); } a.timers[$0] = setInterval(function() { dynCall('vi', $3, [$4]); }, ($1 / $2) * 1000); },  
 156341: ($0) => { var a = Module['SDL3'].dummy_audio; if (a.timers[$0] !== undefined) { clearInterval(a.timers[$0]); } a.timers[$0] = undefined; },  
 156472: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 156619: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 156853: ($0) => { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } var SDL3 = Module['SDL3']; if (!$0) { SDL3.audio_playback = {}; } else { SDL3.audio_recording = {}; } if (!SDL3.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL3.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL3.audioContext = new webkitAudioContext(); } if (SDL3.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL3.audioContext); } } } return (SDL3.audioContext !== undefined); },  
 157416: () => { return Module['SDL3'].audioContext.sampleRate; },  
 157467: ($0, $1, $2, $3) => { var SDL3 = Module['SDL3']; var have_microphone = function(stream) { if (SDL3.audio_recording.silenceTimer !== undefined) { clearInterval(SDL3.audio_recording.silenceTimer); SDL3.audio_recording.silenceTimer = undefined; SDL3.audio_recording.silenceBuffer = undefined } SDL3.audio_recording.mediaStreamNode = SDL3.audioContext.createMediaStreamSource(stream); SDL3.audio_recording.scriptProcessorNode = SDL3.audioContext.createScriptProcessor($1, $0, 1); SDL3.audio_recording.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL3 === undefined) || (SDL3.audio_recording === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL3.audio_recording.currentRecordingBuffer = audioProcessingEvent.inputBuffer; dynCall('ip', $2, [$3]); }; SDL3.audio_recording.mediaStreamNode.connect(SDL3.audio_recording.scriptProcessorNode); SDL3.audio_recording.scriptProcessorNode.connect(SDL3.audioContext.destination); SDL3.audio_recording.stream = stream; }; var no_microphone = function(error) { }; SDL3.audio_recording.silenceBuffer = SDL3.audioContext.createBuffer($0, $1, SDL3.audioContext.sampleRate); SDL3.audio_recording.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL3.audio_recording.currentRecordingBuffer = SDL3.audio_recording.silenceBuffer; dynCall('ip', $2, [$3]); }; SDL3.audio_recording.silenceTimer = setInterval(silence_callback, ($1 / SDL3.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
...
function assignWasmExports(wasmExports) {
  ...
  Module['_SDL_realloc'] = _SDL_realloc = wasmExports['SDL_realloc'];
  _malloc = wasmExports['malloc'];
  _free = wasmExports['free'];
  Module['_Emscripten_HandlePointerEnter'] = _Emscripten_HandlePointerEnter = wasmExports['Emscripten_HandlePointerEnter'];
  Module['_Emscripten_HandlePointerLeave'] = _Emscripten_HandlePointerLeave = wasmExports['Emscripten_HandlePointerLeave'];
  Module['_Emscripten_HandlePointerGeneric'] = _Emscripten_HandlePointerGeneric = wasmExports['Emscripten_HandlePointerGeneric'];
  Module['_Emscripten_SendDragEvent'] = _Emscripten_SendDragEvent = wasmExports['Emscripten_SendDragEvent'];
  Module['_Emscripten_SendDragCompleteEvent'] = _Emscripten_SendDragCompleteEvent = wasmExports['Emscripten_SendDragCompleteEvent'];
  Module['_Emscripten_SendDragTextEvent'] = _Emscripten_SendDragTextEvent = wasmExports['Emscripten_SendDragTextEvent'];
  Module['_Emscripten_SendDragFileEvent'] = _Emscripten_SendDragFileEvent = wasmExports['Emscripten_SendDragFileEvent'];
  Module['_Emscripten_SendSystemThemeChangedEvent'] = _Emscripten_SendSystemThemeChangedEvent = wasmExports['Emscripten_SendSystemThemeChangedEvent'];
  Module['_requestFullscreenThroughSDL'] = _requestFullscreenThroughSDL = wasmExports['requestFullscreenThroughSDL'];
  ...
  dynCalls['viiifi'] = dynCall_viiifi = wasmExports['dynCall_viiifi'];
